...
holidayDefs = ({'month': 7, 'day':1, 'name':{'english': u'Rosh Hashanah','hebrew':u'ראש השנה'}, 'length':2, 'type': 'RH'},
			   ...
			   {'month': 11,'day':15,'name':{'english': "Tu B'Shvat", 'hebrew': u'ט"ו בשבט'}, 'length':1},
			   ...
			   {'month': 12,'day':15,'name':{'english': u'Shushan Purim Katan', 'hebrew': u'פורים קטן דשושן'}, 'length':1, 'leap': True},
			   ...
			   {'month': 1, 'day':27,'name':{'english': u'Holocaust Remembrance Day', 'hebrew': u'יום השואה'}, 'length':1, 'offset': holocaustDay},
			   {'month': 2, 'day':4, 'name':{'english': u'Yom Hazikaron', 'hebrew': u'יום הזיכרון לחללי צה"ל'}, 'length':1, 'offset': remembranceDay},
			   {'month': 2, 'day':5, 'name':{'english': u'Independence Day', 'hebrew': u'יום העצמאות'}, 'length':1, 'offset': independanceDay},
			   ...
			   {'month': 5, 'day':15,'name':{'english': "Tu B'Av", 'hebrew': u'ט"ו באב'}, 'length':1},
