...
holidayDefs = (
    ...
    {'month': 7, 'day': 3, 'name': {'english': u'Fast of Gedaliah', 'hebrew': u'צום גדליה'}, 'length': 1,
     'offset': defer_to_sunday, 'type': 'gedaliah'},
    ...
    {'month': 7, 'day': 15, 'name': {'english': u'Sukkot', 'hebrew': u'סוכות'}, 'length': 1, 'location': 'Israel',
     'type': 'chag'},
    {'month': 7, 'day': 15, 'name': {'english': u'Sukkot', 'hebrew': u'סוכות'}, 'length': 2, 'location': 'Diaspora',
     'type': 'chag'},
    {'month': 7, 'day': 16, 'name': {'english': u'Chol Hamoed Sukkot', 'hebrew': u'חוה"מ סוכות'}, 'length': 5,
     'location': 'Israel', 'type': 'CH'},
    {'month': 7, 'day': 17, 'name': {'english': u'Chol Hamoed Sukkot', 'hebrew': u'חוה"מ סוכות'}, 'length': 4,
     'location': 'Diaspora', 'type': 'CH'},
    {'month': 7, 'day': 21, 'name': {'english': u'Hoshana Raba', 'hebrew': u'הושענא רבה'}, 'length': 1, 'type': 'HR'},
    {'month': 7, 'day': 22, 'name': {'english': u'Simchat Torah', 'hebrew': u'שמחת תורה'}, 'length': 1,
     'location': 'Israel', 'type': 'chag', 'yizkor': True},
    {'month': 7, 'day': 22, 'name': {'english': u'Shmini Atzeret', 'hebrew': u'שמיני עצרת'}, 'length': 1,
     'location': 'Diaspora', 'type': 'chag', 'yizkor': True},
    {'month': 7, 'day': 23, 'name': {'english': u'Simchat Torah', 'hebrew': u'שמחת תורה'}, 'length': 1,
     'location': 'Diaspora', 'type': 'chag'},
    {'month': 8, 'day': 6,
     'name': {'english': u"Start saying v'Ten Tal Umatar", 'hebrew': u'מתחילים לומר "ותן טל ומטר לברכה"'}, 'length': 1,
     'location': 'Israel', 'type': 'rain'},
    {'month': 9, 'day': 25, 'name': {'english': u'Chanukah', 'hebrew': u'חנוכה'}, 'length': 8, 'type': 'chanuka'},
    {'month': 10, 'day': 10, 'name': {'english': u'Fast of 10 Tevet', 'hebrew': u'צום עשרה בטבת'}, 'length': 1,
     'offset': defer_to_sunday, 'type': 'fast'},
    {'month': 11, 'day': 15, 'name': {'english': u"Tu B'Shvat", 'hebrew': u'ט"ו בשבט'}, 'length': 1, 'type': 'other'},
    {'month': 12, 'day': 13, 'name': {'english': u'Fast of Esther', 'hebrew': u'תענית אסתר'}, 'length': 1,
     'offset': preceding_thursday, 'leap': False, 'type': 'esther'},
    {'month': 12, 'day': 14, 'name': {'english': u'Purim', 'hebrew': u'פורים'}, 'length': 1, 'leap': False,
     'type': 'purim'},
    {'month': 12, 'day': 15, 'name': {'english': u'Shushan Purim', 'hebrew': u'שושן פורים'}, 'length': 1, 'leap': False,
     'type': 'SP'},
    {'month': 12, 'day': 14, 'name': {'english': u'Purim Katan', 'hebrew': u'פורים קטן'}, 'length': 1, 'leap': True,
     'type': 'other'},
    {'month': 12, 'day': 15, 'name': {'english': u'Shushan Purim Katan', 'hebrew': u'פורים קטן דשושן'}, 'length': 1,
     'leap': True, 'type': 'other'},
    {'month': 13, 'day': 13, 'name': {'english': u'Fast of Esther', 'hebrew': u'תענית אסתר'}, 'length': 1,
     'offset': preceding_thursday, 'leap': True, 'type': 'esther'},
    {'month': 13, 'day': 14, 'name': {'english': u'Purim', 'hebrew': u'פורים'}, 'length': 1, 'leap': True,
     'type': 'purim'},
    {'month': 13, 'day': 15, 'name': {'english': u'Shushan Purim', 'hebrew': u'שושן פורים'}, 'length': 1, 'leap': True,
     'type': 'SP'},
    {'month': 1, 'day': 14, 'name': {'english': u'Fast of the Firstborn', 'hebrew': u'תענית בכורות'}, 'length': 1,
     'offset': preceding_thursday, 'type': 'firstborn'},
    {'month': 1, 'day': 14, 'name': {'english': u'Erev Pesach', 'hebrew': u'ערב פסח'}, 'length': 1,
     'type': 'erevPesach'},
    {'month': 1, 'day': 15, 'name': {'english': u'Pesach', 'hebrew': u'פסח'}, 'length': 1, 'location': 'Israel',
     'type': 'chag'},
    {'month': 1, 'day': 15, 'name': {'english': u'Pesach', 'hebrew': u'פסח'}, 'length': 2, 'location': 'Diaspora',
     'type': 'chag'},
    {'month': 1, 'day': 16, 'name': {'english': u'Omer', 'hebrew': u'עומר'}, 'length': 49, 'override': omer,
     'type': 'omer'},
    {'month': 1, 'day': 16, 'name': {'english': u'Chol Hamoed Pesach', 'hebrew': u'חוה"מ פסח'}, 'length': 5,
     'location': 'Israel', 'type': 'CH'},
    {'month': 1, 'day': 17, 'name': {'english': u'Chol Hamoed Pesach', 'hebrew': u'חוה"מ פסח'}, 'length': 4,
     'location': 'Diaspora', 'type': 'CH'},
    {'month': 1, 'day': 21, 'name': {'english': u'Pesach', 'hebrew': u'פסח'}, 'length': 1, 'location': 'Israel',
     'dayAdjust': 6, 'type': 'chag', 'yizkor': True},
    {'month': 1, 'day': 21, 'name': {'english': u'Pesach', 'hebrew': u'פסח'}, 'length': 2, 'location': 'Diaspora',
     'dayAdjust': 5, 'type': 'chag', 'yizkor': True},
    {'month': 1, 'day': 27, 'name': {'english': u'Holocaust Remembrance Day', 'hebrew': u'יום השואה'}, 'length': 1,
     'offset': holocaust_day, 'type': 'other'},
    {'month': 2, 'day': 4, 'name': {'english': u'Yom Hazikaron', 'hebrew': u'יום הזיכרון לחללי צה"ל'}, 'length': 1,
     'offset': remembrance_day, 'type': 'other'},
    {'month': 2, 'day': 5, 'name': {'english': u'Independence Day', 'hebrew': u'יום העצמאות'}, 'length': 1,
     'offset': independence_day, 'type': 'independance'},
    {'month': 2, 'day': 14, 'name': {'english': u'Pesach Sheni', 'hebrew': u'פסח שני'}, 'length': 1, 'type': 'other'},
    {'month': 2, 'day': 28, 'name': {'english': u'Jerusalem Day', 'hebrew': u'יום ירושלים'}, 'length': 1,
     'type': 'jerusalem'},
    ...
    {'month': 3, 'day': 6, 'name': {'english': u'Shavuot', 'hebrew': u'שבועות'}, 'length': 1, 'location': 'Israel',
     'type': 'chag', 'yizkor': True},
    {'month': 3, 'day': 6, 'name': {'english': u'Shavuot', 'hebrew': u'שבועות'}, 'length': 2, 'location': 'Diaspora',
     'type': 'chag', 'yizkor': True},
    {'month': 4, 'day': 17, 'name': {'english': u'Fast of 17 Tamuz', 'hebrew': u'תענית י"ז תמוז'}, 'length': 1,
     'offset': defer_to_sunday, 'type': 'fast'},
    {'month': 5, 'day': 9, 'name': {'english': u"Tisha B'Av", 'hebrew': u'תשעה באב'}, 'length': 1,
     'offset': defer_to_sunday, 'type': '9av'},
    {'month': 5, 'day': 15, 'name': {'english': u"Tu B'Av", 'hebrew': u'ט"ו באב'}, 'length': 1, 'type': 'other'},
    {'month': 6, 'day': 29, 'name': {'english': u'Erev Rosh Hashanah', 'hebrew': u'ערב ראש השנה'}, 'length': 1,
     'type': 'erevRH'})
        ...
        for day in range(holiday['length']):
            ...
            if jd in holidays:
                ...
                if holiday['length'] == 1 and 'dayAdjust' not in holiday:
                    fullname = holiday['name'].copy()
                    fullname['type'] = holiday['type']
                    ...
                    fullname = {'english': eng_name, 'hebrew': heb_name, 'type': holiday['type']}
                    holidays[jd]['fullnames'].append(fullname)
                holidays[jd]['type'].append(holiday['type'])
            else:
                full_name = None
                if holiday['length'] == 1:
                    holiday_name = holiday['name'].copy()
                    holiday_name['type'] = holiday['type']
                    full_name = [holiday_name]
                else:
                    if 'override' in holiday:
                    ...
                    full_name = [{'english': eng_name, 'hebrew': heb_name, 'type': holiday['type']}]
                holidays[jd] = {
